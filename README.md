...
설정은 브라우저에서 한다 — [**배열 마법사**](https://chcbaram.github.io/qmk-link/)
([쓰는 법](#배열-만들기--배열-마법사))
